...
public class DesignFunctionCalling extends DesignatorStatement {

    private Designator Designator;
    private ActParsOpt ActParsOpt;

    public DesignFunctionCalling (Designator Designator, ActParsOpt ActParsOpt) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignFunctionCalling(\n");
