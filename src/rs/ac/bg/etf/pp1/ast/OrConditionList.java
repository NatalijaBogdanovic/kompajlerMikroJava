...
public class OrConditionList extends CondTermORList {

    private CondTermORList CondTermORList;
    private CondTerm CondTerm;

    public OrConditionList (CondTermORList CondTermORList, CondTerm CondTerm) {
